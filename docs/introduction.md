...
This is an Open Source Hardware (OSHW) project aimed at creating 1:1 reproduction parts for the Famicom family of consoles for use in repair and customization. In addition, parts will be documented, schematics drawn, and replacements for obsolete parts identified where possible.

# Sample OpenFC Build

![image|512x806](https://starlightk7.github.io/OpenFC/assets/HVC-CPU-07.jpg)
...
There are many reasons why you might want an OpenFC part
...
* Improved Quality
  * OpenFC parts have extra shielding to reduce the notorious jailbar issues of the original console.
* Customization
